...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Oo(e,t,n){return new Fi({name:`SphericalGaussianBlur`,defines:{SAMPLES:po,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:jo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ko(){return new Fi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:jo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ao(){return new Fi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:jo(),fragmentShader:`
